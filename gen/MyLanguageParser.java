...
public class MyLanguageParser extends Parser {
	...
	public static final int
		...
		GREATER_THAN=22, SYMBOL=23, PLUS=24, MINUS=25, MULT=26, DIV=27, ASSIGN=28, 
		LPAREN=29, RPAREN=30, COMMA=31, SEMICOLON=32, LBRACE=33, RBRACE=34, WS=35, 
		COMMENT=36, MULTILINE_COMMENT=37, MULTI_CHARACTER_ERROR=38;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"GREATER_THAN", "SYMBOL", "PLUS", "MINUS", "MULT", "DIV", "ASSIGN", "LPAREN", 
			"RPAREN", "COMMA", "SEMICOLON", "LBRACE", "RBRACE", "WS", "COMMENT", 
			"MULTILINE_COMMENT", "MULTI_CHARACTER_ERROR"
		};
	}
